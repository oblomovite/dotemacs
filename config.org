...
if no region is marked the line is commented instead"
  ...
  (evil-define-key 'normal r-intercept-mode-map
    ...
    (kbd "C-SPC p f") 'affe-find
    (kbd "C-SPC p g") 'affe-grep
...
;;; browse kill ring
    ...
    ;; bookmarks
    (kbd ", B B") 'consult-bookmark
    (kbd ", B s") 'bookmark-save
    )
  ...
  (evil-define-key 'normal elisp-mode-map
  ...
  ;;   (kbd "C-SPC C D f") 'ispell-change-dictionary "francais"
  ;;   (kbd "C-SPC C D e") 'ispell-change-dictionary "english"
  ;;   (kbd "C-SPC C D r") 'ispell-change-dictionary "Russian"
  ;;   (kbd "C-SPC C D d") 'ispell-change-dictionary "francais"
...
#+end_src
** Guess Language
A package to automatically detect the language in a buffer and change
...
(use-package crux
  :init
  (evil-define-key 'normal global-map
    (kbd "C-SPC R B") 'crux-rename-file-and-buffer)
  :config
...
(use-package flymake
  ...
  (add-hook 'prog-mode-hook #'mu-flymake-mode-activate)
  )
...
;; (defface ref-comment-face '((t (:foreground "orange"))) "A face for comments inside brackets")
...
(quelpa '(lsp-tailwindcss :repo "merrickluo/lsp-tailwindcss" :fetcher github))
...
(add-hook 'web-mode-hook  (lambda () (emmet-mode) (js2-minor-mode)
			    ;;(prettier-js-mode)
			   ;; (flymake-mode)
			    ))
)
